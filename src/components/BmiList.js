      ...
      <ul className="list-group ">
        ...
        >
          <div className="row">
            ...
            <div className="col-4 ">{range.normal.low + "-" + range.normal.high + "kg"}</div>
          </div>
        </li>
        <li
          className={
        ...
        >
          <div className="row">
            ...
            <div className="col-4 ">{range.overWeight.low + "-" + range.overWeight.high + "kg"}
            </div>
          </div>
        </li>
        <li
        ...
        >
          <div className="row">
            ...
            <div className="col-4 ">{range.obesityOne.low + "-" + range.obesityOne.high + "kg"}
            </div>
          </div>
        </li>
        <li
        ...
        >
          <div className="row">
            ...
            <div className="col-4 ">{range.obesityTwo.low + "-" + range.obesityTwo.high + "kg"}
            </div>
          </div>
        </li>
        <li
